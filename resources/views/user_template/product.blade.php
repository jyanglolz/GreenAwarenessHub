        ...
        <div class="col-lg-8">
            <div class="box_main">
                <div class="product-info">
                    ...
                    <p class="price_text text-left">Price  <span style="color: #262626;">RM {{$product->price}}</span></p>
                </div>
                   ...
                   <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-4">
                       <div class="box_main">
                          ...
                          <p class="price_text">Price  <span style="color: #262626;">RM {{$product->price}}</span></p>
                          <div class="tshirt_img"><img src="{{ asset($product->product_img) }}"></div>
                          <div class="btn_main">
                             <div class="buy_bt">
                                <form action="{{route('addproducttocart')}}" method="POST">
                             ...
                             <div class="seemore_bt"><a href="{{route('singleproduct',[
