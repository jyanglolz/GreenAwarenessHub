...
<html lang="en">
   ...
   <body>
      ...
      <div class="banner_bg_main">
         ...
         <div class="logo_section">
            <div class="container">
               <div class="row">
                  <div class="col-sm-12">
                     <div class="logo"><a href="index.html"><img style="height:200px"src="{{ asset('home/images/logo-x.png') }}"></a></div>
                  </div>
               </div>
            </div>
         </div>
                           ...
                           <div class="login_menu">
                              <ul>
                                  ...
                                  @else <!-- If the user is authenticated -->
                                      <!-- You can place other links here that should appear after login -->
                                      <li>
                                          <a href="/user-profile">
                                              <i class="fa fa-user" aria-hidden="true"></i>
                                              <span class="padding_10">Profile</span>
                                          </a>
                                      </li>
                                      <li>
      ...
      <!-- banner bg main end -->
            <!--common part-->
            <div class="container py-5" style="margin-top:330px">
               @yield('main-content')
             </div>
              <!-- end of common part-->
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            <div class="footer_logo"><a href="index.html"><img style="height:100px" src="{{ asset('home/images/logo-white.png') }}"></a></div>
            <div class="input_bt">
            ...
            <div class="location_main">Help Line  Number : <a href="#">+60 18 766 3119</a></div>
         </div>
      </div>
      ...
      <script src="{{ asset('home/s/plugin.js') }}"></script>
      <!-- sidebar -->
